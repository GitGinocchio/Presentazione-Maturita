...
call bun run build slides_fsl.md --out ./dist/fsl --base /fsl
...
call bun run export slides_fsl.md --format pdf --output dist/fsl/slides.pdf

call bun run export slides.md --format pptx
call bun run export slides_fsl.md --format pptx
