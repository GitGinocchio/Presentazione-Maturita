  ...
  <div class="flex w-full items-center animate-fade-in duration-700">
    <div class="w-1/2 pr-10 text-left">
      ...
      <p class="text-lg opacity-80">
        ...
        del gestionale tramite Python e Selenium. 
        <br /><br />
...
<div class="absolute inset-0 flex items-center text-left px-12 pt-24 gap-14">
  <div v-click>
  ...
  <div v-click>
    <h3 class="text-xl font-bold mb-2"><a><strong>#</strong> Analisi Logica</a></h3>
    <p class="opacity-70 text-sm">
